...
describe("Cypress Tests to verify tagging functionality", () => {
  ...
  it("7.1 | Adds a question with multiple tags and verifies tags are created", () => {
    loginUser('user123');
  ...
  it("7.2 | Checks if all seeded tags exist on the Tags page", () => {
    loginUser('user123');
  ...
  it("7.3 | Verifies tag counts and question counts display correctly", () => {
    loginUser('user123');
  ...
  it("8.1 | Navigates to questions filtered by 'react' tag", () => {
    loginUser('user123');
  ...
  it("8.2 | Navigates to questions filtered by 'python' tag", () => {
    loginUser('user123');
  ...
  it("10.1 | Clicks on a tag from Tags page and verifies filtered questions all have that tag", () => {
    loginUser('user123');
  ...
  it("10.2 | Clicks on a tag button from question list and verifies tag filtering", () => {
    loginUser('user123');
  ...
  it("10.3 | Verifies tag navigation maintains proper question filtering", () => {
    loginUser('user123');
